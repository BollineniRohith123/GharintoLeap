...
```bash
git remote add encore encore://gharinto-interiors-marketplace-px62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/gharinto-interiors-marketplace-px62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/gharinto-interiors-marketplace-px62/settings/integrations/github)
